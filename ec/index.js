...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 60) return '等级：LV1 文化沙漠';
    if (score <= 89) return '等级：LV2 才疏学浅';
    if (score <= 109) return '等级：LV3 才疏学浅';
    if (score <= 118) return '等级：LV4 文化圣人';
    if (score <= 125) return '等级：LV5 文化圣人';
    if (score <= 135) return '等级：LV6 文化仙子';
    if (score <= 145) return '等级：LV7 文化仙子';
    if (score <= 156) return '等级：LV8 文化宗师';
    if (score <= 173) return '等级：LV9 文化宗师';
    if (score <= 190) return '等级：LV10 文化大帝';
    return '等级：LV∞ 文化始祖';
}
